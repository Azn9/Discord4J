...
public abstract class Routes {
    ...
    /**
     * Get a list of all rules currently configured for guild. Returns a list of auto moderation rule objects for the
     * given guild. Requires the 'MANAGE_GUILD' permission.
     *
     * @see
     * <a href="https://discord.com/developers/docs/resources/auto-moderation#list-auto-moderation-rules-for-guild">
     ...
     */
    public static final Route AUTO_MOD_RULE_GET = Route.get("/guilds/{guild.id}/auto-moderation/rules" +
     ...
     */
    public static final Route AUTO_MOD_RULE_MODIFY = Route.patch("/guilds/{guild.id}/auto-moderation/rules" +
            "/{auto_moderation_rule.id}");
     ...
     */
    public static final Route AUTO_MOD_RULE_DELETE = Route.patch("/guilds/{guild.id}/auto-moderation/rules" +
            "/{auto_moderation_rule.id}");
    ...
    /**
     * Modify the given sticker. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the updated sticker
     * object on success.
     *
    ...
    /**
     * Creates a template for the guild. Requires the MANAGE_GUILD permission. Returns the created template object on
     * success.
     *
    ...
    /**
     * Syncs the template to the guild's current state. Requires the MANAGE_GUILD permission. Returns the template
     * object on success.
     *
     ...
     */
    public static final Route WEBHOOK_MESSAGE_GET = Route.get("/webhooks/{webhook.id}/{webhook" +
    ...
    public static final Route GLOBAL_APPLICATION_COMMANDS_BULK_OVERWRITE = Route.put("/applications/{application" +
            ".id}/commands");

    public static final Route GLOBAL_APPLICATION_COMMAND_GET = Route.get("/applications/{application" +
    ...
    public static final Route GUILD_APPLICATION_COMMANDS_BULK_OVERWRITE = Route.put("/applications/{application" +
            ".id}/guilds/{guild.id}/commands");

    public static final Route GUILD_APPLICATION_COMMAND_GET = Route.get("/applications/{application.id}/guilds/{guild" +
            ".id}/commands/{command.id}");
    ...
    public static final Route GUILD_APPLICATION_COMMAND_PERMISSIONS_GET = Route.get("/applications/{application" +
            ".id}/guilds/{guild.id}/commands/permissions");

    public static final Route APPLICATION_COMMAND_PERMISSIONS_GET = Route.get("/applications/{application" +
            ".id}/guilds/{guild.id}/commands/{command.id}/permissions");

    public static final Route APPLICATION_COMMAND_PERMISSIONS_MODIFY = Route.put("/applications/{application" +
            ".id}/guilds/{guild.id}/commands/{command.id}/permissions");

    public static final Route APPLICATION_COMMAND_PERMISSIONS_BULK_MODIFY = Route.put("/applications/{application" +
            ".id}/guilds/{guild.id}/commands/permissions");
     ...
     *
     * @see
     * <a href="https://discord.com/developers/docs/resources/guild-scheduled-event#list-scheduled-events-for-guild">
     ...
     */
    public static final Route GUILD_SCHEDULED_EVENT_MODIFY = Route.patch("/guilds/{guild.id}/scheduled-events/{event" +
            ".id}");
     ...
     */
    public static final Route GUILD_SCHEDULED_EVENT_DELETE = Route.delete("/guilds/{guild.id}/scheduled-events/{event" +
            ".id}");
     ...
     */
    public static final Route GUILD_SCHEDULED_EVENT_USERS_GET = Route.get("/guilds/{guild.id}/scheduled-events/{event" +
            ".id}/users");
