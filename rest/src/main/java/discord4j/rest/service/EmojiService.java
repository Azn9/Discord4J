...
public class EmojiService extends RestService {
    ...
    public Flux<EmojiData> getApplicationEmojis(long applicationId) {
    ...
    public Mono<EmojiData> getApplicationEmoji(long applicationId, long emojiId) {
        return Routes.APPLICATION_EMOJI_GET.newRequest(applicationId, emojiId)
            .exchange(getRouter())
            .bodyToMono(EmojiData.class);
    }
