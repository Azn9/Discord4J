 ...
 *
 * @see <a href="https://discord.com/developers/docs/topics/gateway-events#guild-scheduled-event-create">Discord</a>
 */
public class ScheduledEventCreateEvent extends GuildEvent {

    private final ScheduledEvent scheduledEvent;

    public ScheduledEventCreateEvent(GatewayDiscordClient gateway, ShardInfo shardInfo, ScheduledEvent scheduledEvent) {
     ...
     *
     * @return a created scheduled event
     */
    ...
    public String toString() {
        return "ScheduledEventCreateEvent{" +
