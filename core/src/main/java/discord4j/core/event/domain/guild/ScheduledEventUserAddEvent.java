 ...
 *
 * @see <a href="https://discord.com/developers/docs/topics/gateway-events#guild-scheduled-event-user-add">Discord</a>
 */
public class ScheduledEventUserAddEvent extends GuildEvent {
    ...
    public ScheduledEventUserAddEvent(GatewayDiscordClient gateway, ShardInfo shardInfo,
    ...
    public String toString() {
        return "ScheduledEventUserAddEvent{" +
                "guildId=" + guildId +
